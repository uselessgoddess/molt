...
/// Where a request points: half name a range the table already has a record
/// for, since a range nobody mapped only ever proves refusals. The rest, and the
/// fallback when no record exists yet, are generated outright.
#[derive(Clone, Copy, Debug)]
struct Aim {
    live: Option<Index>,
    fresh: Fresh,
