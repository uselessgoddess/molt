...
/// Picks a queue size the driver can host: the device's maximum, capped at
/// [`MAX_SIZE`](queue::MAX_SIZE). A device offering no queue is refused.
...
mod tests {
    ...
    #[test]
    fn a_deep_device_queue_is_capped_at_the_drivers_maximum() {
    ...
    #[test]
    fn a_device_without_a_queue_is_refused() {
